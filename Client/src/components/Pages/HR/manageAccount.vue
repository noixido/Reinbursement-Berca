      ...
      <div class="overflow-x-auto">
            ...
            <tr v-for="(account, index) in paginatedAccounts" :key="account.id_Account">
              ...
              <td class="p-2 text-center">
                <div class="flex gap-5 justify-center">
                  ...
                  <div class="relative group">
                    <div class="tooltip tooltip-black">
                      <button class="btn btn-warning" @click="editAccount(account)">
                  ...
                  <div class="relative group">
                    <div class="tooltip tooltip-black">
                      <button class="btn btn-error" @click="deleteAccount(account.email)">
                  ...
                  <div class="relative group">
                    <div class="tooltip tooltip-black">
                      <button class="btn bg-red-600 hover:bg-red-700" @click="resetPassword(account.email)">
        ...
        <div class="flex justify-between mt-5">
          ...
          <div class="join mt-4">
            ...
            <button v-if="showEllipsis" class="join-item btn btn-disabled">
              ...
            </button>
...
export default {
  ...
  methods: {
    ...
    resetPassword(email) {
      Swal.fire({
        title: "Are you sure?",
        text: "You will reset password for this account!",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
        ...
        if (result.isConfirmed) {
          const api = "https://localhost:7102/api/Account/ResetPassword/" + email;
          return axios
            .put(api, {}, {
              headers: {
                Authorization: `Bearer ${this.token}`,
