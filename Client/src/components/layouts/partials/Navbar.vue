<template>
    <nav class="bg-[#17244b] px-4 py-2 flex justify-between items-center">
        <!-- Sidebar Toggle -->
        ...
        <div class="flex items-center space-x-2">
            <!-- Nama Akun -->
            <span class="text-sm text-white font-semibold">{{ accountName }}</span>

            <!-- Dropdown -->
            <div class="dropdown dropdown-end">
                <div tabindex="0" role="button" class="btn btn-ghost hover:bg-indigo-900 btn-circle avatar">
                    <div class="w-10 rounded-full ">
                        <!-- If no profile picture, show silhouette -->
                        <svg v-if="!userProfilePicture" xmlns="http://www.w3.org/2000/svg" class="w-5 h-10 text-white mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
